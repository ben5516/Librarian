...
[See what a library's most popular book is (where popularity is measured by the number of times a book's been requested; different libraries should have different answers to this question)]
