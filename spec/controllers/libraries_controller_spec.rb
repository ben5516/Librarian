...
describe LibrariesController do
  ...
  let(:valid_attributes) { { "name" => "Library Name", "address" => "Street Address", "city" => "city name", "state" => "MO", "zip" => "63010" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested library" do
        ...
        expect_any_instance_of(Library).to receive(:update).with({ "name" => "MyString" })
